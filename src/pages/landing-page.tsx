    ...
    return(
        <>
            ...
            >
                ...
                <p className="text-[#111827] text-[36px] leading-[auto] font-semibold text-center font-inter">
                    Start Tracking Smarter.
                    <br/>
                    Take control of your money with AI-powered insights.
                </p>
                <p className="text-[#6B7280] text-[24px] italic font-inter text-center">
